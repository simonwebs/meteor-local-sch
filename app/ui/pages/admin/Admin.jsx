...
const navigation = [
  ...
  { name: 'Enrollement', href: '/enrollementList', icon: ClockIcon, current: false },
   { name: 'Re-Enrollement', href: 'reEnrollementList', icon: ScaleIcon, current: false },
  { name: 'Employment', href: 'employmentList', icon: ScaleIcon, current: false },
